      ...
      <RevealOnScroll>
        <div className="max-w-6xl mx-auto px-4">
          <div className="mb-12 text-center">
            <p className="text-sm uppercase tracking-[0.35em] text-purple-400/80 mb-3">
              Featured games
            </p>
            ...
            <p className="max-w-2xl mx-auto text-gray-400">
              A modular showcase built to highlight gameplay systems, engine
              work, and production-ready game builds. Swap in new titles as you
              publish them and keep the page fast with lightweight media.
            </p>
          </div>
