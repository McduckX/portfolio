            ...
            <RevealOnScroll>
                <div className="text-center z-10 px-4">
                    ...
                    <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
                        Software Engineer & Game Developer specializing in Godot, gameplay systems, and 2D pixel art.
                        I build polished game prototypes, procedural systems, and player-first mechanics for fast iteration
